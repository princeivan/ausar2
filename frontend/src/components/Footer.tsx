...
const Footer = () => {
  return (
    <footer className="bg-brand-darkGray text-white pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Ausar Creative</h3>
            <p className="text-gray-300 mb-4">
              Your one-stop solution for custom branded products. Quality
              merchandise with your unique branding.
            </p>
